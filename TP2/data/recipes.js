  ...
  recipes: [
    {
      ...
      steps: [
        {
          ordre: 1,
          titre: "Faire les pois chiches croustillants",
        ...
        },
        {
          ...
          texte: "Rincer le quinoa. Une fois l'eau bouillante, ajouter le quinoa et cuire 14-15 minutes jusqu'à tendreté. Égoutter et réserver."
        },
        {
          ordre: 3,
          titre: "Mise en place",
          image: "./assets/img/bol_mexicain_3.jpg",
          texte: "Hacher la coriandre et l'oignon. Couper la tomate en dés. Zester la lime et couper en deux. Trancher le halloumi."
        },
        {
          ordre: 4,
          titre: "Cuire le halloumi",
          image: "./assets/img/bol_mexicain_4.jpg",
          texte: "Dans un poêle, à feu moyen-élevé, cuire les tranches de halloumi environ 2-3 minutes de chaque côté jusqu'à coloration."
        },
        {
          ordre: 5,
          titre: "Faire le pico de gallo et la sauce",
        ...
        {
          ordre: 6,
          titre: "Monter l'assiette",
          image: "./assets/img/bol_mexicain_6.jpg",
          texte: "Servir le quinoa avec les pois chiches croustillants, le halloumi et le pico de gallo. Garnir avec la sauce. Bon appétit!"
        }
      ]
    },
    {
      ...
      steps: [
        ...
        {
          ordre: 4,
          titre: "Cuire les lanières de boeuf",
    ...
    },
    {
      ...
      steps: [
        {
          ordre: 1,
          titre: "Adapter la recette pour vos enfants",
        ...
        },
        {
          ...
          texte: "Trancher finement le poivron. Hacher le persil. Égoutter l'ananas et le couper en plus petits cubes au choix."
        },
        {
          ordre: 4,
          titre: "Rouler la pâte",
        ...
        },
        {
          ...
          texte: "Servir et garnir de persil. Ajuster le sel et le poivre au goût. Bon appétit!"
        }
      ]
    },
    {
      ...
      steps: [
        {
          ...
          texte: "Amener une casserole avec 2 tasses d'eau à ébullition. Rincer le riz. Verser le riz, couvrir et cuire à feu doux 10-12 minutes."
        },
        {
          ordre: 2,
          titre: "Mise en place",
        ...
        },
        {
          ...
          texte: "Servir le riz dans un bol avec les légumes et le tofu. Garnir avec la sauce tonkatsu et les oignons Bon appétit!"
        }
      ]
    },
    {
      ...
      steps: [
        {
          ordre: 1,
          titre: "Hydrater les champignons",
        ...
        },
        {
          ...
          texte: "Trancher finement les champignons café, le poireau et l'oignon vert. Hacher l'ail. Écraser les noisettes grossièrement."
        },
        {
          ordre: 3,
          titre: "Cuire les champignons",
        ...
        {
          ordre: 4,
          titre: "Cuire les chips (optionnel)",
