...
export default class RecipesDisplayer {
  ...
  displayCategory (category) {
    this.displayRecipes(recipeManager.filterRecipes(category));
  }
   ...
   */
  displayResearch (ingredient, matchExact) {
    this.displayRecipes(recipeManager.filterByIngredient(ingredient, matchExact));
  }
