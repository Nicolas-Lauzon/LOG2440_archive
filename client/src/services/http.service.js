...
class HTTPService {
  ...
  /**
   * Fait une requête GET à /api/recipes pour obtenir toutes les recettes
   * @returns
   */
  ...
  /**
   * Fait une requête vers /recipes/category/:category
  ...
  /**
   * Fait une requête vers /recipes/ingredient/:ingredient?matchExact
   ...
   *
   * Ex : /recipes/ingredient/monIngredient?matchExact=true si le paramètre est à true
   * sinon : /recipes/ingredient/monIngredient
